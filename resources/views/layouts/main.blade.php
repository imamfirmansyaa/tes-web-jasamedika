...
<head>
    ...
    <script>
        (function(w, d, s, l, i) {
            ...
            var f = d.getElementsByTagName(s)[0],
                ...
                dl = l != 'dataLayer' ? '&amp;l=' + l : '';
            j.async = true;
            j.src = 'https://www.googletagmanager.com/ns.html?id=GTM-5FS8GGP';
    ...
    <link href="{{ asset('theme/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle1036.css?v=2.1.1') }}"
...
<body id="kt_body"
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">Admin
                        Prodi</a>
                    <div class="navi mt-1">
        ...
        <script>
            function deletePloting(id, name) {
                $('#modal-name').html(name);
                $('#modal-confirm_delete').attr('onclick', `confirmDeletePloting(${id})`);
                $('#deleteModal').modal('show');
            }

            function confirmDeletePloting(id) {
                $.ajaxSetup({
                    headers: {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // var url = ""; //the url I want to redirect to
        ...
        <script>
            function deleteFaculty(id, name) {
                $('#modal-name').html(name);
                $('#modal-confirm_delete').attr('onclick', `confirmDeleteFaculty(${id})`);
                $('#deleteModal').modal('show');
            }
        ...
        <script>
            function deleteTopic(id, name) {
                $('#modal-name').html(name);
                $('#modal-confirm_delete').attr('onclick', `confirmDeleteTopic(${id})`);
                $('#deleteModal').modal('show');
            }
        ...
        <script>
            function deleteSubmission(id, name) {
                $('#modal-name').html(name);
                $('#modal-confirm_delete').attr('onclick', `confirmDeleteSubmission(${id})`);
                $('#deleteModal').modal('show');
            }
        ...
        <script>
            function deleteLecturer(id, name) {
                $('#modal-name').html(name);
                $('#modal-confirm_delete').attr('onclick', `confirmDeleteLecturer(${id})`);
                $('#deleteModal').modal('show');
            }
        ...
        <script>
            function deleteStudent(id, name) {
                $('#modal-name').html(name);
                $('#modal-confirm_delete').attr('onclick', `confirmDeleteStudent(${id})`);
                $('#deleteModal').modal('show');
            }
        ...
        <script>
            $(document).ready(function() {
                // $.noConflict();
                $('#kt_datatable-lecturer').DataTable({
                    "language": {
               ...
               var table = $('#kt_datatable-recomendation').DataTable({
                   "pageLength": 50,
               ...
               var tableLiterature = $('#kt_datatable-literature').DataTable({
                   "pageLength": 50,
                   "lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
                    paging: true,
                    responsive: true,
                ...
                $('a.toggle-vis').on('click', function(e) {
                    ...
                    // Get the column API object
                    var column = tableLiterature.column($(this).attr('data-column'));
                ...
                $('#kt_datatable-student').DataTable({
                    "language": {
                        "lengthMenu": "Show _MENU_",
                    },
                    "dom": "<'row'" +
        ...
        <script>
            $(document).ready(function() {
                $('#kt_datatable-submission').DataTable({
                    "language": {
                        "lengthMenu": "Show _MENU_",
                    },
                    "dom": "<'row'" +
        ...
        <script>
            $(document).ready(function() {
                $('#kt_datatable-faculty').DataTable({
                    "language": {
                        "lengthMenu": "Show _MENU_",
                    },
                    "dom": "<'row'" +
        ...
        <script>
            $(document).ready(function() {
                $('#kt_datatable-certificate').DataTable({
                    "language": {
                        "lengthMenu": "Show _MENU_",
                    },
                    "dom": "<'row'" +
