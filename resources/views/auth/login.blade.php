                    ...
                    @endif
                            ...
                            <div class="pb-5 pb-lg-15">
                                ...
                                <div class="text-muted font-weight-bold font-size-h4">Belum Ada Akun?
                                    <a href="{{ route('register.create') }}" class="text-primary font-weight-bolder">Klik Disini!</a></div>
                            </div>
                            <!--begin::Title-->
                            <!--begin::Form group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Nama</label>
                                <input class="form-control h-auto py-6 rounded-lg border-0" placeholder="Masukan Email Anda" type="text" id="name" name="name" autocomplete="off" />

                            </div>

                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">No. Sim</label>
                                <input class="form-control h-auto py-6 rounded-lg border-0" placeholder="Masukan Email Anda" type="text" id="no_sim" name="no_sim" autocomplete="off" />
