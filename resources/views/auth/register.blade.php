...
<head>
    ...
    <link href="{{ asset('theme/demo1/dist/assets/css/pages/login/login-31036.css?v=2.1.1') }}" rel="stylesheet"
        type="text/css" />
        ...
        <div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="login-aside d-flex flex-column flex-row-auto">
                ...
                <div class="d-flex flex-column-auto flex-column py-lg-20 py-10 mb-20">
                    ...
                    <!--end::Aside header-->
                    <!--begin::Aside Title-->
                    <h3 class="font-weight-bolder text-center font-size-h4 text-dark-50 line-height-xl">SELAMAT DATANG
                        <br />RENTAL MOBIL
                    </h3>
                    <!--end::Aside Title-->
                </div>
                <!--end::Aside Top-->
                <!--begin::Aside Bottom-->
                <div class="d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center bgi-size-contain"
                    style="background-image: url(https://preview.keenthemes.com/keen/theme/demo1/dist/assets/media/svg/illustrations/accomplishment.svg)">
                </div>
                <!--end::Aside Bottom-->
            </div>
            <!--begin::Aside-->
                ...
                <div class="d-flex flex-row-fluid flex-center">
                    ...
                    @endif
                            <div class="pb-5 pb-lg-15">
                                <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Registrasi Akun
                                </h3>
                                <div class="text-muted font-weight-bold font-size-h4">Punya akun?
                                    <a href="{{ route('login') }}" class="text-primary font-weight-bolder">Klik
                                        Disini!</a>
                                </div>
                            </div>
                            <!--begin::Title-->
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control"
                                        placeholder="Masukan Kembali Kata Sandi" name="confirm-password" />
                                </div>
                            </div>
                            <!--end::Form group-->
                            <!--begin::Action-->
                            <div class="pb-lg-0 pb-5 px-3">
